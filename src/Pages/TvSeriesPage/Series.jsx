  ...
  return (
    <main className="flex flex-col gap-2">
      ...
      <div className="grid gap-3">
        ...
        <div className="grid grid-cols-[164px_164px] md:grid-cols-[220px_220px_220px]  md:gap-x-[2rem] md:px-2 md:gap-y-[1.2rem] 2xl:grid-cols-[280px_280px_280px_280px] gap-2 justify-evenly md:justify-start  lg:gap-x-[6.5rem] lg:gap-y-[1rem] 2xl:gap-[1.5rem] ">
          {series.map((s, i) => {
            ...
            return (
              <section className="flex flex-col gap-1">
                ...
                <div className="flex flex-col font-Outfit text-white ">
                  ...
                  <h2 className="md:text-[18px] font-medium text-[14px]">
                    {title}
                  </h2>
                </div>
              </section>
